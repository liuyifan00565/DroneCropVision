...
train_result = model.train(data=config.TRAIN_DATA, epochs=config.TRAIN_EPOCHS, batch=config.TRAIN_BATCH,
                           ...
                           workers=config.TRAIN_WORKERS, single_cls=config.TRAIN_SINGLE_CLS, plots=config.TRAIN_PLOTS,
                           scale=config.TRAIN_SCALE
                           # translate=config.TRAIN_TRANSLATE, copy_paste=config.TRAIN_COPY_PASTE,
                           # mosaic=config.TRAIN_MOSAIC, mixup=config.TRAIN_MIXUP
                           )
